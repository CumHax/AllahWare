...
import allah.owns.me.allahware.guiscreen.render.components.widgets.*;
...
public class ModuleButton {
	...
	public ModuleButton(Hack module, Frame master) {
		...
		for (Setting settings : Client.get_setting_manager().get_settings_with_hack(module)) {
		...
		int size = Client.get_setting_manager().get_settings_with_hack(module).size();
	...
	public void render(int mx, int my, int separe) {
		...
		int nm_r = Client.click_gui.theme_widget_name_r;
		int nm_g = Client.click_gui.theme_widget_name_g;
		int nm_b = Client.click_gui.theme_widget_name_b;
		int nm_a = Client.click_gui.theme_widget_name_a;
		...
		int bd_r = Client.click_gui.theme_widget_border_r;
		int bd_g = Client.click_gui.theme_widget_border_g;
		int bd_b = Client.click_gui.theme_widget_border_b;
