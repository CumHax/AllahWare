package allah.owns.me.allahware.guiscreen.render.components;
...
public class Frame {
	...
	public Frame(Category category) {
		...
		int size  = Client.get_hack_manager().get_modules_with_category(category).size();
		int count = 0;

		for (Hack modules : Client.get_hack_manager().get_modules_with_category(category)) {
	...
	public void refresh_frame(ModuleButton button, int combo_height) {
		...
		int size  = Client.get_hack_manager().get_modules_with_category(this.category).size();
		int count = 0;
	...
	public void render(int mx, int my) {
		...
		int nc_r = Client.click_gui.theme_frame_name_r;
		int nc_g = Client.click_gui.theme_frame_name_g;
		int nc_b = Client.click_gui.theme_frame_name_b;
		int nc_a = Client.click_gui.theme_frame_name_a;

		int bg_r = Client.click_gui.theme_frame_background_r;
		int bg_g = Client.click_gui.theme_frame_background_g;
		int bg_b = Client.click_gui.theme_frame_background_b;
		int bg_a = Client.click_gui.theme_frame_background_a;

		int bd_r = Client.click_gui.theme_frame_border_r;
		int bd_g = Client.click_gui.theme_frame_border_g;
		int bd_b = Client.click_gui.theme_frame_border_b;
		int bd_a = Client.click_gui.theme_frame_border_a;
