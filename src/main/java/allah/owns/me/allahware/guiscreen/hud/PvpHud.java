...
public class PvpHud extends Pinnable {
    ...
    public String selftrap_enabled() {
        try {
            if (Client.get_hack_manager().get_module_with_tag("SelfTrap").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String aura_enabled() {
        ...
        try {
            if (Client.get_hack_manager().get_module_with_tag("AutoCrystal").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String socks_enabled() {
        try {
            if (Client.get_hack_manager().get_module_with_tag("Socks").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
